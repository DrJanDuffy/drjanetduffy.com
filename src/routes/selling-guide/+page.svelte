<script>
	import { Home, TrendingUp, DollarSign, FileText, CheckCircle, BarChart3, Camera, Key } from 'lucide-svelte';
</script>

<svelte:head>
	<title>Home Selling Guide | Las Vegas | Dr. Janet Duffy REALTOR®</title>
	<meta name="description" content="Complete guide to selling your home in Las Vegas. Expert tips on pricing, staging, marketing, and maximizing your sale price." />
</svelte:head>
	...
	<div class="container-premium">
		<div class="text-center mb-16">
			<h1 class="font-display text-4xl sm:text-5xl md:text-6xl font-bold mb-6 text-gray-900">
				Complete Guide to Selling Your Las Vegas Home
			</h1>
						...
						<div class="flex-1">
							...
							<ul class="space-y-2 text-gray-700">
								<li class="flex items-start gap-2">
									...
									<span>Comparative Market Analysis (CMA) of similar properties</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Current market conditions and trends analysis</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Strategic pricing to maximize value and minimize time on market</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="flex items-start gap-6">
						...
						<div class="flex-1">
							...
							<ul class="space-y-2 text-gray-700">
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Deep clean and declutter throughout</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Make necessary repairs and updates</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Consider professional staging for maximum impact</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="flex items-start gap-6">
						...
						<div class="flex-1">
							...
							<ul class="space-y-2 text-gray-700">
								...
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>MLS listing and online marketing</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
					...
					<div class="flex items-start gap-6">
						...
						<div class="flex-1">
							...
							<ul class="space-y-2 text-gray-700">
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Review and compare multiple offers</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Negotiate price, terms, and contingencies</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Accept the best offer and move to contract</span>
								</li>
							</ul>
						</div>
					</div>
					...
					<div class="flex items-start gap-6">
						...
						<div class="flex-1">
							...
							<ul class="space-y-2 text-gray-700">
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Coordinate buyer inspections and appraisals</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Address any repair requests or credits</span>
								</li>
								<li class="flex items-start gap-2">
									<CheckCircle class="w-5 h-5 text-green-600 mt-0.5 flex-shrink-0" />
									<span>Complete closing and transfer ownership</span>
								</li>
							</ul>
						</div>
					</div>
		...
		<div class="bg-gradient-to-r from-primary-600 to-primary-700 rounded-2xl p-12 text-center text-white">
			<h2 class="text-3xl font-bold mb-4">Ready to Sell Your Home?</h2>
			<p class="text-lg text-white text-opacity-90 mb-8 max-w-2xl mx-auto">
				Let me help you maximize your sale price and minimize time on market
			</p>
